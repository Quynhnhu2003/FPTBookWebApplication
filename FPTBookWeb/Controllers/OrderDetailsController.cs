...
namespace FPTWeb.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,BookId,Quantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,OrderId,BookId,Quantity")] OrderDetail orderDetail)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FptbookContext.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
