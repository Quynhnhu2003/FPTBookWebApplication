    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Author__8E2731B95227E36E", x => x.authorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    cartId = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cart__415B03B88F84BCEC", x => x.cartId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__0809335D2413CF33", x => x.orderId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderIte__3214EC07C3B643EE", x => x.Id);
                    table.ForeignKey(
                        name: "fk_bookId2",
                        column: x => x.bookId,
                        principalTable: "Book",
